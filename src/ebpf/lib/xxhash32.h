...
static __always_inline void process(const void* data, uint32_t *state0, uint32_t *state1, uint32_t *state2, uint32_t *state3)
{
...
static __always_inline uint32_t xxhash32_anylength(const void* input, const uint32_t totalLength, const uint32_t seed){
...
static __always_inline uint32_t xxhash32(const void* input, const uint32_t totalLength, const uint32_t seed){
